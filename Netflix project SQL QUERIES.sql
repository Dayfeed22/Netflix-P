...
--Q6 Find Content Added in the Last 7 Years

SELECT *
FROM netflix
WHERE TO_DATE(date_added, 'Month DD, YYYY') >= CURRENT_DATE - INTERVAL '7 years';

--Q7 Find All Movies/TV Shows by Director 'Kirsten Johnson'
...
--Q8 List All TV Shows with More Than 2 Seasons
...
--Q10 Find each year and the average numbers of content release in Spain on netflix.
...
--Q13  Find How Many Movies Actor 'Salman Khan' Appeared in the Last 12 Years
